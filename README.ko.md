...
* 사각형, 원, 선, 화살표, 텍스트, 이미지, 블러 브러시를 그릴 수 있습니다.
...
* 마우스 휠로 확대/축소할 수 있으며, Option + Wheel을 사용하면 더 세밀하게 조절할 수 있습니다.
...
* 표시 버튼으로 레이어의 표시 여부를 전환할 수 있습니다.
* 잠금 버튼으로 레이어 잠금 여부를 전환할 수 있습니다.
...
* Brush 도구를 사용해 블러 마스크를 칠할 수 있습니다.
