...
void ApplyDarkEditorStyle() {
    ...
    colors[ImGuiCol_SliderGrab] = ImVec4(0.35f, 0.70f, 1.00f, 1.00f);
    colors[ImGuiCol_SliderGrabActive] = ImVec4(0.50f, 0.80f, 1.00f, 1.00f);
    colors[ImGuiCol_Button] = ImVec4(0.17f, 0.19f, 0.22f, 1.00f);
    colors[ImGuiCol_ButtonHovered] = ImVec4(0.22f, 0.25f, 0.29f, 1.00f);
    colors[ImGuiCol_ButtonActive] = ImVec4(0.28f, 0.32f, 0.38f, 1.00f);
    colors[ImGuiCol_Header] = ImVec4(0.18f, 0.34f, 0.52f, 1.00f);
    colors[ImGuiCol_HeaderHovered] = ImVec4(0.22f, 0.42f, 0.64f, 1.00f);
    colors[ImGuiCol_HeaderActive] = ImVec4(0.25f, 0.50f, 0.76f, 1.00f);
    colors[ImGuiCol_Separator] = ImVec4(0.20f, 0.22f, 0.25f, 1.00f);
    colors[ImGuiCol_SeparatorHovered] = ImVec4(0.30f, 0.55f, 0.78f, 1.00f);
    colors[ImGuiCol_SeparatorActive] = ImVec4(0.35f, 0.65f, 0.92f, 1.00f);
    colors[ImGuiCol_ResizeGrip] = ImVec4(0.35f, 0.70f, 1.00f, 0.15f);
    colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.35f, 0.70f, 1.00f, 0.35f);
    colors[ImGuiCol_ResizeGripActive] = ImVec4(0.35f, 0.70f, 1.00f, 0.60f);
    colors[ImGuiCol_Tab] = ImVec4(0.14f, 0.15f, 0.17f, 1.00f);
    colors[ImGuiCol_TabHovered] = ImVec4(0.22f, 0.42f, 0.64f, 1.00f);
    colors[ImGuiCol_TabActive] = ImVec4(0.18f, 0.34f, 0.52f, 1.00f);
    ...
    colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.35f, 0.70f, 1.00f, 1.00f);
    colors[ImGuiCol_PlotHistogram] = ImVec4(0.35f, 0.70f, 1.00f, 1.00f);
    ...
    colors[ImGuiCol_TextSelectedBg] = ImVec4(0.25f, 0.50f, 0.76f, 0.45f);
    colors[ImGuiCol_DragDropTarget] = ImVec4(0.35f, 0.70f, 1.00f, 0.90f);
    colors[ImGuiCol_NavHighlight] = ImVec4(0.35f, 0.70f, 1.00f, 0.90f);
